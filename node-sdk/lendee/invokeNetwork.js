  ...
  invokeCreate: async function (request) {
    ...
    try {
      ...
      let user_from_store = await Fabric_Client.newDefaultKeyValueStore({ path: store_path
        ...
        return fabric_client.getUserContext('lendee', true);
      });

      if (user_from_store && user_from_store.isEnrolled()) {
        console.log('Successfully loaded lendee from persistence');
      } else {
        throw new Error('Failed to get lendee.... run registerUserNetwork.js');
      }
